...
<div id="loginModal" class="modal show" tabindex="-1" role="dialog" aria-hidden="true">
  ...
  <div class="modal-content">
      ...
      <div class="modal-body">
		<form id="myForm" class="form col-md-12 center-block" action='mainAluno.php' method="post">
	...
	<?php
		...
		if (!empty($_POST['automatic']))
		{
			...
			$sqlInsert = "INSERT INTO `atividades`(`nome`, `matricula`, `disciplina`, `responsavel`, `tipo`, `atividade`, `descricao`, `pendente`, `horas`, `dataAtv`) VALUES (\"$nome\",$matricula,\"$disciplina\",\"$professor\", \"$tipo\", \"$atividade\",\"$descricao\",1,0,\"$dataAtv\")";			
		...
		echo "<input type='hidden' name='alert' value='Atividade cadastrada com sucesso'>";
