<?php
						...
						<div class="form-group" align="center">
							<input type="checkbox" name="Read" value="Read">Ciente
						</div>
						
						<div class="form-group">
								<button type="submit" class="btn btn-primary btn-lg btn-block" onclick="ValidateCheckBox('Read')" formaction="registromonitoria.php">Cadastrar</button>
						</div>
		...
		{ 
			...
			{
				var box= alert("Li e Concordo com o abaixo informado");
			}
		}
