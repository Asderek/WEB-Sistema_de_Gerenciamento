<?php
	...
	if($rowsAluno1 <0)
	{
		...
		echo '<a href="mainMonitor.php">asd</a>';
	...
	else
	{
		...
		if($rowsAluno>0)
		{
			...
			else
			{
				...
				echo "<a href=\"http://mainMonitor.php\" class=\"btn btn-primary btn-lg\">Cadastrar Plantoes</a>";
			}										
		}else
		{
		...
		echo "<form id=\"id_auto\" action=\"mainMonitor.php\" method=\"post\">";
			...
			echo "<input type=\"hidden\" name=\"mode\" value=\"calendario\">";
		echo "</form>";
		echo "<script>
