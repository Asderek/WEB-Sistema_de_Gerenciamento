<?php
	...
	$professorMonitoria = PROFESSORES_GETNAME($matriculaResponsavel);
	...
	echo "<button type=\"submit\" value=\"verassistido$CPF\" name=\"mode\" align=\"right\">Ver Ficha</button><br><br>";
	...
	echo "
		...
		<table class=\"table table-bordered table-hover\">
			...
			if ($professorMonitoria == $responsavel)
			{
				echo "
					<tr> 
						<td width=\"30%\">
			...
			echo "	
				...
				for($i=0;$i<$length;$i++)
				{
					...
					echo"
							<tr>
								<td width=\"10%\">$date</td>
								<td width=\"80%\">$coment</td>	
								<td width=\"5%\">$commentAutor</td>	";
								if ($professorMonitoria == $responsavel)
									echo "<td width=\"5%\"><button type=\"submit\" formaction=\"deletecomentario.php\" name=\"targetcomment\" value=\"$deletComment\">X</button></td>";
								echo "
							</tr>
						";
				} echo "
