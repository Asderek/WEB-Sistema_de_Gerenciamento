<?php
	...
	if ($nomeArquivo == "")
	{
		echo "<form id=\"id_auto\" action=\"mainSecretaria.php\" method=\"post\">";
			echo "<input type=\"hidden\" name=\"idCaso\" value=\"$indexCaso\">";
			echo "<input type=\"hidden\" name=\"mode\" value=\"mostracaso\">";
			echo "<h3> Nome do Arquivo não pode ser vazio<br>Por favor, escolha um nome para o arquivo (aqui no sistema)</h3>";
