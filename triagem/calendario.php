...
<div id="loginModal" class="modal show" tabindex="-1" role="dialog" aria-hidden="true">
  ...
  <div class="modal-content">
      <div class="modal-header">
		...
		<div class="modal-body" id="id_divBody">
		<?php
      ...
      <div class="modal-footer"></div>
        ...
        $(document).ready(function() {
            ...
            document.getElementById("id_divBody").style.height = (screen.height-screen.height*0.34)+"px";
            document.getElementById("id_divBody").style.width = (screen.height-screen.width)+"px";
