<?php
							...
							echo "<button type=\"submit\" value=\"verassistido$CPF\" name=\"mode\" align=\"right\" class=\"btn btn-primary\"><strong>Ver Ficha</strong></button>";
							
							if ($responsavel == PROFESSORES_GETNAME($matricula))
							{
								echo "<button id=\"id_audiencia\" type=\"submit\" value=\"audiencia\" name=\"mode\" class=\"btn btn-primary\"><strong>Marcar Audiencia</strong></button>"; 
							...
							$endereco = $resultAssistido[0]['endereco'];
							$cep = $resultAssistido[0]['CEP'];
							$renda = $resultAssistido[0]['renda'];
							$moradia = $resultAssistido[0]['moradia'];
							$ocupacao = $resultAssistido[0]['ocupacao'];
							$estadocivil = $resultAssistido[0]['estadocivil'];
							...
							$local = $resultAssistencia[0]['local'];
							$acao = $resultAssistencia[0]['acao'];
							...
							$anotacoes = $resultAssistencia[0]['anotacoes'];
							...
							echo "<table class=\"table table-bordered table-hover\">
									<tbody>
											...
											if ($arquivado == 1)
											{
												...
												<tr bgcolor = \"#ff8080\"> 
													<td colspan='3' align='center'>
														<strong>OBS: Este Caso está Arquivado</strong>
													</td >
												</tr>";
											}
											if ($orientacao == 1)
											{
												...
												<tr bgcolor = \"#ffe6ff\"> 
													<td colspan='3' align='center'>
														<strong>OBS: Cliente é apenas Orientação</strong>
													</td >
												</tr>";
											}
											echo "<tr> 
							...
							echo "
								...
								<table class=\"table table-bordered table-hover\">
									<tbody>";
										...
										if ($arquivado == 0 && $responsavel == PROFESSORES_GETNAME($matricula))
										{
											echo "
												<tr> 
												<td width=\"30%\">
										...
										for($i=0;$i<$length;$i++)
										{
											...
											$deletComment = '|'.$date.'#'.$commentAutor.'&'.$coment;
											...
											echo"
													<tr>
														<td width=\"10%\">$date</td>
														<td width=\"80%\" colspan=\"$colspan\">$coment</td>	
														<td width=\"5%\">$commentAutor</td>";

														
													if ($arquivado == 0 && $responsavel == PROFESSORES_GETNAME($matricula))
													{
														echo "														
															<td width=\"5%\"><button type=\"submit\" formaction=\"deletecomentario.php\" name=\"targetcomment\" value=\"$deletComment\">X</button></td>
														";
													}
													echo "
													</tr>
							...
							for($i=0;$i<count($arrayArquivos);$i++)
							{
								...
								echo"
										<tr>
											...
											<td colspan=\"$colspan\"><a href=\"$diretorio/$nomeDoArquivo\" target=\"_blank\">$displayName.pdf</a></td>	
											";
											if ($arquivado == 0 && $responsavel == PROFESSORES_GETNAME($matricula))
											{
												echo "
...
<script>
	var width = document.getElementById('id_rightDiv').offsetWidth / 2;
	width -= document.getElementById('id_audiencia').offsetWidth/1.8;
	console.log(width);
	document.getElementById('id_audiencia').style = "margin-left:"+width+"px";
</script>