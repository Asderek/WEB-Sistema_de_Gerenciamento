...
<?php
	...
	$sqlCalendario = "SELECT * FROM `calendario` WHERE `mes` = \"$mes\" AND `ano` = \"$ano\" AND (`destino` = \"global\" OR `destino` = \"alunos\") ORDER BY dia, mes";
	...
	$sqlClientes = "SELECT * FROM `atendimentos` WHERE `responsavel` = \"$nomeProfessor\" AND `dataDeRetorno` LIKE \"%$data\" ORDER BY `dataDeRetorno`";
